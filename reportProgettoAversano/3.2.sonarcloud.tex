...
\begin{itemize}
	\item Gradle - SonarScanner per Gradle
	\item MSBuild - SonarScanner per MSBuild
	\item Maven - use the SonarScanner per Maven
	\item Ant - SonarScanner per Ant
	\item SonarScanner	
\end{itemize}
